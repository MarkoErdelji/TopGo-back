insert into users (id,address,email,first_name,last_name,password,phone_number,profile_picture,is_active,is_blocked,user_type) values  (1,'test','test1','test','test','test','test','test',FALSE,FALSE,1);
insert into users (id,address,email,first_name,last_name,password,phone_number,profile_picture,is_active,is_blocked,user_type) values  (2,'test','test2','test','test','test','test','test',FALSE,FALSE,2);
insert into users (id,address,email,first_name,last_name,password,phone_number,profile_picture,is_active,is_blocked,user_type) values  (3,'test','test3','test','test','test','test','test',FALSE,FALSE,3);
